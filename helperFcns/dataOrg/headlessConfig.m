...
%autoDiameter defaults ON: a wrong --diameter returns nothing rather than
%something worse, so a fixed cohort-wide value drops whole animals silently
%(TO0002's BPN root finds 47 cells at 10 and 0 at 15).
